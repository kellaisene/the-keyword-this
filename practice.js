...
//   It's the only way to refer to an object that is being implimented in a function without writing out the whole object again.
      //Answer
...
var boundFn = getMyUsername.bind(myUser) //Fix this
console.log(boundFn())
...
//In the example above, what is the 'this keyword' bound to when getMyUsername runs?
  ...
  //Answer Here
//It's bound to the default window because it doesn't know what this. is referring to.
